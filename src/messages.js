...
module.exports = Tag => ({
    ...
    "lookup_challengers confidence_low" : [
        ...
        'Tu léxico es tan elevado que ni un bot te puede entender :jenkins_triggered:',
    ],
    ...
    "lookup_challengers myself_all": [
        ...
        Tag `Que se arme el *Money Match*:\n\n${'listOfValidPlayers'}\n\nTe va a dar frío? :animated_snowman:`,
    ...
    "reported_result valid_obliterated": [
        ...
        Tag `Hasta a mi me dolio el ${'highScore'} - ${'lowScore'} que te puso el ${'winner'}, ${'loser'} y eso que soy un bot y no siento dolor!.`,
